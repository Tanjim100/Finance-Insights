...
const ResoucesPage = () => {
  ...
  const numberOfPages = Math.ceil(resources?.length / itemsPerPage);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="This is the Resources page of my Website" />
      ...
      <div className="max-w-7xl mx-auto px-5">
        <HeaderTitle
          ...
          para={"Download helpful guides, worksheets, and reference materials"}
        />
        ...
        <div className="filter flex justify-between my-12 gap-4">
            ...
            <div>
              <label htmlFor="Headline">
                <select
                  name="Headline"
                  id="Headline"
                  className="mt-0.5 rounded-full p-2 border h-10 border-gray-700 shadow-sm text-xs md:text-sm w-50 "
            ...
            <div className="">
              <label htmlFor="Search">
                <select
                  name="Headline"
                  id="Headline"
                  className=" w-full rounded-full p-2 border h-10 border-gray-700 shadow-sm text-xs md:text-sm"
                  value={sortBy}
          ...
          <div>
            <div className="relative">
              <button>
                <IoSearch className="absolute left-65 md:left-90 bottom-2 z-10 text-2xl text-black" />
              </button>
              <input
                type="text"
                placeholder="Search Resources"
                className="input pr-12 bg-transparent border-black rounded-full w-75 md:w-100 z-5 placeholder-black"
                value={searchQuery}
        ...
        <div className="pagination flex justify-center gap-2 my-16">
          ...
          {pages.map((page) => (
            <button
              className={`btn btn-xs md:btn-md border-none shadow-none ${page == currentPage
                ? `bg-black text-white`
                : `bg-[#E6E8EA] text-black`
                }`}
              key={page}
