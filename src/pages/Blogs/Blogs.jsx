...
const Blogs = () => {
    ...
    return (
        <>
            ...
            <Helmet>
                <title>Blogs | FINANCE INSIGHTS</title>
                <meta name="description" content="This is the Blogs page of my Website" />
                {/* <meta property="og:title" content="Blogs Page" />
                                            ...
                                            {tags.map((tag) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`px-4 py-2 rounded-full text-sm font-normal transition-all duration-200 ${isSelected
                                                            ? "bg-black text-white"
                                                            : "bg-white text-[#01101C] hover:bg-black hover:text-white"
                                                            }`}
                                                    >
                                                        {tag.name}
                                                    </button>
