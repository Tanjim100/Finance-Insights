  ...
  return (
    <div>
      <article className="overflow-hidden rounded-2xl border border-[#E6E8EA] bg-white shadow-xs p-3 ">
        ...
        <div className="">
          <div className="h-36">
            <h6 className="text-sm mb-2 text-[#01101C] uppercase">
              {categories?.name}
            </h6>
            ...
            <p className="mt-2 line-clamp-2 text-sm/relaxed text-[#55636F] font-serif  font-normal tracking-[0.48px]">
              {description}
            </p>
          </div>

          <div className="group mt-1 flex items-center gap-1 justify-between">
