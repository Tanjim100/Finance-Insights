...
const Banner = () => {
  return (
    <div>
      <section
        className="bg-white lg:grid lg:h-screen  bg-bottom bg-contain md:bg-cover bg-no-repeat "
        ...
        <div className="mx-auto w-screen max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32 ">
          <div className="max-w-prose h-80 text-left">
            <h1 className="text-2xl font-bold text-gray-900 md:text-5xl">
              Expert Insights on Finance, Accounting and Beyond
            </h1>
            ...
            <div className="mt-4 flex gap-4 sm:mt-6">
              <a
                href="#"
                className="btn btn-sm rounded-full md:btn-lg"
              >
